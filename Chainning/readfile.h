...
#define MBUCKETS  7					//Number of BUCKETS
#define RECORDSPERBUCKET 2				//No. of records inside each Bucket
#define BUCKETSIZE sizeof(Bucket)		//Size of the bucket (in bytes)

#define OVERFLOWRECORDS 6
#define OF_RECORD_SIZE sizeof(OverFlowRecord)

#define FILESIZE BUCKETSIZE*MBUCKETS +  OVERFLOWRECORDS*OF_RECORD_SIZE //Size of the file
